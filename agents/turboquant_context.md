...
GitHub: https://github.com/tsuyu122/TurboQuant-Vulkan
...
## Regra principal
Pode fazer qualquer coisa, desde que NÃO copie fundamentos dos modelos anteriores.
...
## Projeto
* Caminho: c:\Users\hm\Desktop\TurboQuant vulkan
* Repositório: https://github.com/tsuyu122/TurboQuant-Vulkan
* Estado atual: Testando TQ3_2
* Branch atual: main

## Setup
* GPU: AMD (Vulkan)
* Modelo usado: Gemma 4 26B Q4_K_M
* Sistema operacional: Windows

## Estado dos modelos
* TQ2_0: ✅ Implementado
* TQ3_0: ✅ Implementado
* TQ3_1: ✅ Implementado (excelente trade-off)
* TQ3_2: 🔄 Em testes
* TQ3_3: ⏳ Planejamento

## Próximas ações
* Validar TQ3_2 em contextos longos
* Comparar qualidade vs TQ3_1
* Planejar TQ3_3
