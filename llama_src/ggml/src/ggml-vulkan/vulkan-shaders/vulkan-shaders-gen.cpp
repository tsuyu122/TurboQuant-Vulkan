...
void process_shaders() {
    ...
    for (const bool& fp16 : {false, true}) {
        ...
        for (const bool& f16acc : {false, true}) {
            ...
            for (const auto& tname : type_names) {
                ...
                } else if (tname != "tq3_0" && tname != "tq3_2" && tname != "tq3_3" && tname != "tq2_0") {
                    std::string data_a_key = "DATA_A_" + to_uppercase(tname);
                    string_to_spv("flash_attn_f32_f16_" + tname, "flash_attn_cm2.comp",
                ...
                } else if (tname == "q4_0" || tname == "q4_1" || tname == "q5_0" || tname == "q5_1" || tname == "iq4_nl" || tname == "q8_0" || tname == "f32" || tname == "tq3_0" || tname == "tq3_2" || tname == "tq3_3" || tname == "tq2_0") {
                    std::string data_a_key = "DATA_A_" + to_uppercase(tname);
                    string_to_spv("flash_attn_f32_f16_" + tname, "flash_attn.comp",
            ...
            string_to_spv("flash_attn_f32_f16_tq3k_tq2v", "flash_attn.comp",
                merge_maps(fa_base_dict, {{"MIXED_KV_TQ3K_TQ2V", "1"}, {"Q_TYPE", "float"}, {"D_TYPE", "float"}, {"D_TYPEV4", "vec4"}, {"BLOCK_SIZE", "QUANT_K_TQ3_0"}}), fp16, false, false, f16acc);

            // Mixed KV: K=TQ3_0 + V=TQ3_2 (enhanced V decode with recency window)
            string_to_spv("flash_attn_f32_f16_tq3k_tq3_2v", "flash_attn.comp",
                merge_maps(fa_base_dict, {{"MIXED_KV_TQ3K_TQ3_2V", "1"}, {"Q_TYPE", "float"}, {"D_TYPE", "float"}, {"D_TYPEV4", "vec4"}, {"BLOCK_SIZE", "QUANT_K_TQ3_0"}}), fp16, false, false, f16acc);

            // Mixed KV: K=TQ3_0 + V=TQ3_3 (Lloyd-Max V centroids + cross-quad decorrelation)
            string_to_spv("flash_attn_f32_f16_tq3k_tq3_3v", "flash_attn.comp",
                merge_maps(fa_base_dict, {{"MIXED_KV_TQ3K_TQ3_3V", "1"}, {"Q_TYPE", "float"}, {"D_TYPE", "float"}, {"D_TYPEV4", "vec4"}, {"BLOCK_SIZE", "QUANT_K_TQ3_0"}}), fp16, false, false, f16acc);
        }
    }
    ...
    for (std::string t : {"q1_0", "q4_0", "q4_1", "q5_0", "q5_1", "q8_0", "iq4_nl", "tq3_0", "tq3_2", "tq3_3", "tq2_0"}) {
    ...
    for (std::string t : {"f32", "f16", "bf16", "q1_0", "q4_0", "q4_1", "q5_0", "q5_1", "q8_0", "iq4_nl", "tq3_0", "tq3_2", "tq3_3", "tq2_0"}) {
