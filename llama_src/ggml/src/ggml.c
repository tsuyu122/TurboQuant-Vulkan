...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TQ3_2] = {
        .type_name                = "tq3_2",
        .blck_size                = QK_TQ3_2,
        .type_size                = sizeof(block_tq3_2),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_tq3_2,
        .from_float_ref           = (ggml_from_float_t) quantize_row_tq3_2_ref,
    },
    [GGML_TYPE_TQ3_3] = {
        // TQ3_3 shares storage format with TQ3_2 (same block struct); only the
        // Vulkan flash-attention decode kernel differs (Lloyd-Max centroids
        // + cross-quad decorrelation). CPU quantize/dequantize are aliased.
        .type_name                = "tq3_3",
        .blck_size                = QK_TQ3_2,
        .type_size                = sizeof(block_tq3_2),
        .is_quantized             = true,
