...
void quantize_row_tq3_2(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
...
void ggml_vec_dot_tq3_2_q8_K(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
