...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_Q1_0    = 41,
        GGML_TYPE_TQ3_0   = 42, // TurboQuant-Lite 3-bit (Lloyd-Max optimal codebook)
        GGML_TYPE_TQ3_2   = 43, // TurboQuant 3-bit dynamic recency (recent=full, old=reduced)
        GGML_TYPE_TQ3_3   = 44, // TurboQuant 3-bit Lloyd-Max V + cross-quad decorrelation (compute-only)
        GGML_TYPE_COUNT   = 45,
    };
